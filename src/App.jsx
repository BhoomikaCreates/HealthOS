...
// 1. IMPORT your robot JSON file here (Make sure the name matches)
import robotAnimation from "./assets/robot.json"; 
import { Droplets, Moon, Footprints, Flame, Plus, X, Sparkles, Target, Trophy, Zap } from "lucide-react"; 
    ...
    <div className="flex bg-black min-h-screen text-white relative">
      ...
      <div className="ml-64 p-8 w-full">
        ...
        <div className="mt-10 mb-10">
          <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-2">Achievements & Badges <Trophy className="text-yellow-400" size={22} /></h2>
